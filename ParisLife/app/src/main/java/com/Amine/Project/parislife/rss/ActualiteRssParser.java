...
public class ActualiteRssParser {
	...
	public List<RssItem> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
		...
		while (parser.next() != XmlPullParser.END_DOCUMENT) {
			...
			if (title != null && link != null && url !=null&& description !=null&& date !=null ){
				RssItem item = new RssItem(title, link, url,description,date);
				items.add(item);
				title = null;
				link = null;
				url =null;
	...
	public String readUrl(XmlPullParser parser) throws XmlPullParserException, IOException {
	...
	public String readDate(XmlPullParser parser) throws XmlPullParserException, IOException {
